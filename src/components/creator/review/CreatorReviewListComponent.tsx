        ...
        <div className="container mx-auto mb-20 px-5">
            ...
            {allReviews.length === 0 ? (
                ...
                <div className="relative">
                        ...
                        {allReviews.map((review, index) => (
                            <SwiperSlide key={index}>
                                ...
                                >
                                    ...
                                    <div>
                                        <div className="text-sm font-semibold md:text-base truncate overflow-hidden text-ellipsis whitespace-nowrap">
                                            {review.productName}
                                        </div>
                    ...
                    <div className="custom-pagination2 absolute bottom-[-30px] left-0 right-0 flex justify-center gap-0.5 z-10"></div>

                    <div className="swiper-button-prev2 absolute top-[50%] left-[-28px] transform -translate-y-1/2 z-10 flex items-center justify-center w-10 h-10 cursor-pointer">
                        <img src={prev2} alt="이전" className="w-4 h-4" />
                    </div>
                    <div className="swiper-button-next2 absolute top-[50%] right-[-28px] transform -translate-y-1/2 z-10 flex items-center justify-center w-10 h-10 cursor-pointer">
